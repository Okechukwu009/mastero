...
const Hero = () => {
  ...
  const carouselData = [
    ...
    {
      id: 2,
      mainImage: '/src/assets/model-2.jpg',
      topImage: '/src/assets/fashion-2.jpg',
      bottomImage: '/src/assets/clothes-2.jpg'
    },
    {
      id: 3,
      mainImage: '/src/assets/model-3.jpg',
      topImage: '/src/assets/fashion-3.jpg',
      bottomImage: '/src/assets/clothes-3.jpg'
    }
  ];
